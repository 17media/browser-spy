...
declare const useCompleteSectionTracking: (ref: RefObject<any>, callback: Function) => void;
declare const useHalfSectionTracking: (ref: RefObject<any>, callback: Function) => void;
declare const useMinSectionTracking: (ref: RefObject<any>, callback: Function) => void;
declare const useRankSectionTracking: (ref: RefObject<any>, callback: Function) => void;
declare function testing(): void;
...
declare function createProfileClickAction(userID: string, liveStatus: boolean, profileType: string): EventAction;
...
declare function createSectionViewAction(section: string): EventAction;
export { Agent, FirebaseAgent, MatomoAgentConfig, MatomoAgent, Source, DefaultSource, Threshold, Scene, TransitionEvent, TrackingEventParams, TrackingEvent, DefaultEventParams, LoginEvent, RefinedEventPathname, ElementMap, SpyEvent, EventCallback, EventListener, completeSectionObserver, halfSectionObserver, minSectionObserver, rankSectionObserver, useCompleteSectionTracking, useHalfSectionTracking, useMinSectionTracking, useRankSectionTracking, testing, createButtonClickAction, createPageEnterAction, createPageLeaveAction, createTabClickAction, createProfileClickAction, createSearchAction, createVoteAction, createLeaderboardSectionViewAction, createLinkClickAction, createSectionViewAction };
