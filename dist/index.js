...
function getUserID() {
  var qsUserID = qs__default['default'].parse(window.location.search, {
...
exports.createDefaultEventParams = createDefaultEventParams;
...
exports.createV2TrackingEvent = createTrackingEvent;
